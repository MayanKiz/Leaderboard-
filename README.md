# Color Rush Leaderboard

## Description

A lightweight leaderboard interface for displaying scores from a color-reflex game.
...
- Ranked score presentation.
- responsive layout.
- static browser deployment.
- clear result-focused UI.
